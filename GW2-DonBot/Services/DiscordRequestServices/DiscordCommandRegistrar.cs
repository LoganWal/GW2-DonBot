...
public class DiscordCommandRegistrar(ILogger<DiscordCommandRegistrar> logger)
{
    ...
    private static ApplicationCommandProperties[] BuildCommands()
    {
        ...
        [
            ...
            new SlashCommandBuilder()
                .WithName("add_quote")
                .WithDescription("Add a quote to the guild quote pool used in message footers.")
            ...
            new SlashCommandBuilder()
                ...
                .AddOption(new SlashCommandOptionBuilder()
                    .WithName("secondary_member_role_ids")
                ...
                .AddOption(new SlashCommandOptionBuilder()
                    .WithName("art_spam_filter_enabled")
                    .WithDescription("Enable or disable automatic art commission spam removal. Default: disabled.")
                    .WithType(ApplicationCommandOptionType.SubCommand)
                    .AddOption("value", ApplicationCommandOptionType.Boolean, "Enable art spam removal?", isRequired: true))
                .AddOption(new SlashCommandOptionBuilder()
                ...
                .AddOption(new SlashCommandOptionBuilder()
                    .WithName("player_point_rankings_enabled")
                    .WithDescription("Enable or disable player point ranking posts. Default: disabled.")
                    .WithType(ApplicationCommandOptionType.SubCommand)
                    .AddOption("value", ApplicationCommandOptionType.Boolean, "Enable player point rankings?", isRequired: true))
                .AddOption(new SlashCommandOptionBuilder()
                    .WithName("player_point_rankings_channel")
                    .WithDescription("Set the channel for player point ranking posts.")
                    .WithType(ApplicationCommandOptionType.SubCommand)
                    .AddOption("channel", ApplicationCommandOptionType.Channel, "The channel", isRequired: true))
                .AddOption(new SlashCommandOptionBuilder()
